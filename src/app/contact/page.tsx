  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "brandonclarktech@gmail.com",
      link: "mailto:brandonclarktech@gmail.com",
    },
    {
      icon: <PhoneIcon sx={{ fontSize: 40, color: "primary.main" }} />,
      title: "Phone",
      value: "+1 (917)-733-7651",
      link: "tel:+19177337651",
    },
    {
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/bleeclark",
      color: "#333",
    },
    {
      icon: <LinkedInIcon sx={{ fontSize: 32 }} />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/brandonclarkswift",
      color: "#0077b5",
    },
    {
      icon: <TwitterIcon sx={{ fontSize: 32 }} />,
      name: "Twitter",
      url: "https://x.com/theamazingclark",
      color: "#1da1f2",
    },
  ];
