  ...
  const projects = [
    {
      ...
      image: generateProjectImage(1, "Enterprise API Connectors"),
      technologies: [
        "Python",
        "AWS",
        "REST API",
    ...
    },
    {
      ...
      image: generateProjectImage(2, "AI-Powered Developer Tools"),
      technologies: [
        "Python",
        "AI/ML",
        "FastAPI",
...
class CodeAnalysisModel:
    ...
    },
    {
      ...
      image: generateProjectImage(3, "Cloud-Native CI/CD Pipeline"),
      technologies: [
        "AWS",
        "Docker",
        "Kubernetes",
...
spec:
  ...
  template:
    ...
    },
    {
      ...
      image: generateProjectImage(4, "ETL Data Processing System"),
      technologies: [
        "Python",
        "Apache Airflow",
        "AWS S3",
...
def process_data_pipeline():
    ...
    },
    {
      ...
      image: generateProjectImage(5, "Microservices Architecture"),
...
async def get_user(user_id: int):
    ...
    },
    {
      ...
      image: generateProjectImage(6, "Security Monitoring Platform"),
      technologies: [
        "Python",
        "AWS WAF",
        "CloudWatch",
...
class SecurityAlertHandler:
    ...
    },
    {
      ...
      image: generateProjectImage(7, "React E-Commerce Platform"),
      technologies: [
        "React",
        "Next.js",
        "TypeScript",
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    },
    {
      ...
      image: generateProjectImage(8, "Node.js Microservices API"),
      technologies: [
        "Node.js",
        "Express",
        "TypeScript",
...
export default new UserService();`,
    ...
    },
    {
      ...
      image: generateProjectImage(9, "Laravel Admin Dashboard"),
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <motion.div variants={itemVariants}>
                  ...
                  >
                    ...
                    solutions. Expertise in AI-powered automation and building
