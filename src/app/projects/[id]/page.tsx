...
const ProjectDetailPage = () => {
  ...
  const projects = {
    1: {
      ...
      description: 'Scalable API-driven connectors integrating Salesforce and GitHub platforms with comprehensive error handling and monitoring.',
      ...
      images: getProjectImages(1, 'API Connectors'),
      videos: ['/api-connectors-demo.mp4'],
      technologies: ['Python', 'AWS', 'REST API', 'Docker', 'PostgreSQL', 'FastAPI', 'Redis'],
...
async def sync_salesforce_to_github(data):
    ...
    2: {
      ...
      description: 'Intelligent automation tools that improved code review efficiency using machine learning algorithms and natural language processing.',
      longDescription: 'Built an AI-powered code review system that automatically detects potential issues, suggests improvements, and provides intelligent recommendations to developers. The system uses advanced NLP techniques and machine learning models to understand code context and provide meaningful feedback.',
      images: getProjectImages(2, 'AI Tools'),
      videos: ['/ai-tools-demo.mp4'],
      technologies: ['Python', 'AI/ML', 'FastAPI', 'PostgreSQL', 'TensorFlow', 'OpenAI', 'Docker'],
...
class CodeAnalysisModel:
    ...
    3: {
      ...
      description: 'Designed automated deployment pipeline with comprehensive testing, security scanning, and rollback capabilities.',
      longDescription: 'Created a robust CI/CD pipeline that automates the entire software delivery process from code commit to production deployment with zero-downtime updates. The pipeline includes automated testing, security scanning, performance testing, and blue-green deployments.',
      images: getProjectImages(3, 'CI/CD Pipeline'),
      videos: ['/cicd-demo.mp4'],
      technologies: ['AWS', 'Docker', 'Kubernetes', 'Jenkins', 'Terraform', 'Helm', 'Prometheus'],
...
spec:
  ...
  template:
    ...
    4: {
      ...
      description: 'Optimized data pipelines with real-time processing, data validation, and comprehensive monitoring dashboards.',
      longDescription: 'Developed a scalable ETL system that processes millions of records daily, transforming raw data into actionable insights with automated quality checks.',
      images: getProjectImages(4, 'ETL System'),
      videos: ['/etl-demo.mp4'],
      technologies: ['Python', 'Apache Airflow', 'AWS S3', 'Redshift', 'Spark', 'Pandas'],
...
def process_data_pipeline():
    ...
    5: {
      ...
      description: 'Constructed scalable microservices with service discovery, load balancing, and distributed tracing capabilities.',
      longDescription: 'Architected a microservices-based system that improved scalability and maintainability while reducing system complexity and deployment risks.',
      images: getProjectImages(5, 'Microservices'),
...
async def get_user(user_id: int):
    ...
    6: {
      ...
      description: 'Automated security scanning with real-time threat detection, vulnerability assessment, and compliance reporting.',
      longDescription: 'Built a comprehensive security monitoring platform that continuously scans for vulnerabilities and provides real-time alerts for potential security threats.',
      images: getProjectImages(6, 'Security Platform'),
      videos: ['/security-demo.mp4'],
      technologies: ['Python', 'AWS WAF', 'CloudWatch', 'Security Tools', 'ELK Stack', 'Grafana'],
...
class SecurityAlertHandler:
    ...
    7: {
      ...
      description: 'Modern e-commerce platform built with React, Next.js, and TypeScript featuring real-time inventory management and payment processing.',
      ...
      images: getProjectImages(7, 'React E-Commerce Platform'),
      videos: ['/react-ecommerce-demo.mp4'],
      technologies: ['React', 'Next.js', 'TypeScript', 'Stripe', 'PostgreSQL', 'Tailwind CSS', 'Redux Toolkit'],
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    8: {
      ...
      description: 'Scalable microservices architecture built with Node.js, Express, and TypeScript for high-performance API services.',
      longDescription: 'Architected and developed a microservices-based API platform that handles millions of requests with high availability and fault tolerance. The system uses event-driven architecture with message queues, implements centralized logging, and provides comprehensive monitoring and health checks.',
      images: getProjectImages(8, 'Node.js Microservices API'),
      videos: ['/nodejs-microservices-demo.mp4'],
      technologies: ['Node.js', 'Express', 'TypeScript', 'MongoDB', 'Redis', 'Docker', 'Consul'],
...
export default new UserService();`
    ...
    9: {
      ...
      description: 'Comprehensive admin dashboard built with Laravel, featuring user management, analytics, and real-time notifications.',
      longDescription: 'Developed a feature-rich admin dashboard using Laravel with modern PHP practices, providing comprehensive management tools for business operations. The system includes role-based access control, real-time notifications, and optimized database queries for handling large datasets.',
      images: getProjectImages(9, 'Laravel Admin Dashboard'),
      videos: ['/laravel-admin-demo.mp4'],
      technologies: ['Laravel', 'PHP', 'MySQL', 'Vue.js', 'Bootstrap', 'Redis', 'WebSockets'],
      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            right: 0,
            bottom: 0,
            background: 'radial-gradient(circle at 30% 20%, rgba(99, 102, 241, 0.1) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(236, 72, 153, 0.1) 0%, transparent 50%)',
            zIndex: 0,
          },
        }}
      >
                  ...
                  <Grid container spacing={4}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Card sx={{ p: 3, height: '100%' }}>
                        <Typography variant="h5" component="h3" gutterBottom sx={{ fontWeight: 600, color: 'error.main' }}>
                          Challenges
                        </Typography>
                        <Box>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Card sx={{ p: 3, height: '100%' }}>
                        <Typography variant="h5" component="h3" gutterBottom sx={{ fontWeight: 600, color: 'success.main' }}>
                          Solutions
                        </Typography>
                        <Box>
